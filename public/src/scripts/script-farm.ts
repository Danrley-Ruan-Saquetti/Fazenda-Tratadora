...
import { MainControl } from "../controller/control-main.js"
import { RenderControl } from "../controller/control-render.js"
import { GLOBAL_DEPENDENCE, GLOBAL_TEMPLATE } from "../global.js"
import { clone, converterStringToJSON } from "../util/util.js"
import { PreloadPanel } from "./preload.js"

export function FarmScript(idPanel: string) {
    ...
    plantDeadlineTest
    plantPriceTest
    const PARAMS: ISettingsTemplate = GLOBAL_DEPENDENCE == "production" ? clone(GLOBAL_TEMPLATE) : {
        "settings": {
            "table": {
