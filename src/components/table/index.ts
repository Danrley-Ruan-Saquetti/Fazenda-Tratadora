function tableComponent({ table: tableEl, headers }: { table: HTMLElement, headers: ITableData[] }, onSelection: (listSelected: string[]) => void, colResizableProps: { liveDrag?: Boolean, resizeMode?: string, minWidth?: number, headerOnly?: Boolean, hoverCursor?: string, dragCursor?: string, onResize: () => void, draggingClass?: string } = { dragCursor: "ew-resize", headerOnly: true, hoverCursor: "ew-resize", liveDrag: true, resizeMode: 'overflow', minWidth: 64, onResize: () => { }, draggingClass: "anchor-drag-column-table" }) {
