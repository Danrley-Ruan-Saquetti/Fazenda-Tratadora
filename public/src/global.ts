...
export const GLOBAL_TEMPLATE: ISettingsTemplate = {
    "settings": {
        "table": {
            "cep.initial": "",
            "cep.final": "",
...
export const GLOBAL_SETTINGS: ISettingsGeneral = {
    "table": {
        "cep.initial": "",
        "cep.final": "",
        "deadline": "",
...
export const GLOBAL_SETTINGS_RESET = {
    table: {
        "cep.final": "",
        "cep.initial": "",
        "selection.criteria": {
...
export const isDev = ControlDataBase().getItem<Boolean>("dev.edition") || false

export const GLOBAL_DEPENDENCE: TDependence = !isDev ? "production" : "development"

export const GLOBAL_HISTORY: IHistoryTable = []

export const GLOBAL_ROUTERS: TItemRoute[] = [
...
export const GLOBAL_ROUTERS_OPEN: TRouterName[] = ["feature"]

export const GLOBAL_ROUTER_NOT_FOUND = `<h1>Router not found</h1>`

export const GLOBAL_ROUTERS_ROUTER: TDependenceRouter = {
